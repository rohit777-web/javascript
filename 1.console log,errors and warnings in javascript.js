// console.log : This method is used to log(print) output in console.
// examples:
console.log('rohit sharma'); //string
console.log(1); // integer value
console.log(true); //boolean value
console.log(null); ;  
console.log([1, 2, 3]); // array inside log
console.log({name:"rohit",language:"javascript",ide:"vscode"}); // object inside log
